...
public class SecurityConfig {
	...
	/**
	 * 비밀번호를 암호화하기 위한 PasswordEncoder 빈을 정의합니다. BCryptPasswordEncoder는 강력한 암호화 알고리즘을
	 * 사용하여 비밀번호를 암호화합니다.
	 *
	...
	/**
	 * AuthenticationManager 빈을 정의합니다. AuthenticationManager는 인증 요청을 처리하는데 사용됩니다.
	...
	/**
	 * Spring Security의 보안 필터 체인을 설정합니다. HTTP 요청에 대한 권한 부여 및 인증을 구성합니다.
	 *
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(authorizeRequests -> authorizeRequests.requestMatchers("/siteRecipe/{id}/like")
						.authenticated() // 좋아요 요청은 로그인 필요
						.requestMatchers("/userRecipe", "userRecipe_write").authenticated().anyRequest().permitAll())
